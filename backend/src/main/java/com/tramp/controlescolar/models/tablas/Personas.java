...
@NamedStoredProcedureQuery(
        name = "Personas.insertarPersona",
        procedureName = "SDP_INSERTA_PERSONAS_SISTEMA",
        parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "StrNombre", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "StrApellidos", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "BitSexo", type = Boolean.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "IntEdad", type = Integer.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "DateFechaNacimiento", type = Date.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "StrRFC", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "StrNumeroCelular", type = String.class),

                @StoredProcedureParameter(mode = ParameterMode.IN, name = "IntIdCategoria", type = Integer.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "IntIdCarrera", type = Integer.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "StrContraseña", type = String.class)
        }
)
