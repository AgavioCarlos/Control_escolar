...
INSERT INTO cat_perfiles(cperfil, bhabilitado, dfecha_alta)
VALUES  ('Alumno', 1, NOW()),
        ('Profesor', 1, NOW()),
        ('Administrador', 1, NOW());
...
VALUES  
    ('A1', 1, NOW()), ('A2', 1, NOW()), ('A3', 1, NOW()), ('A4', 1, NOW()), ('A5', 1, NOW()), ('A6', 1, NOW()), ('A7', 1, NOW()), ('A8', 1, NOW()), ('A9', 1, NOW()), ('A10', 1, NOW()), ('A11', 1, NOW()), ('A12', 1, NOW()),
    ('B1', 1, NOW()), ('B2', 1, NOW()), ('B3', 1, NOW()), ('B4', 1, NOW()), ('B5', 1, NOW()), ('B6', 1, NOW()), ('B7', 1, NOW()), ('B8', 1, NOW()), ('B9', 1, NOW()), ('B10', 1, NOW()), ('B11', 1, NOW()), ('B12', 1, NOW()),
    ('C1', 1, NOW()), ('C2', 1, NOW()), ('C3', 1, NOW()), ('C4', 1, NOW()), ('C5', 1, NOW()), ('C6', 1, NOW()), ('C7', 1, NOW()), ('C8', 1, NOW()), ('C9', 1, NOW()), ('C10', 1, NOW()), ('C11', 1, NOW()), ('C12', 1, NOW()),
    ('D1', 1, NOW()), ('D2', 1, NOW()), ('D3', 1, NOW()), ('D4', 1, NOW()), ('D5', 1, NOW()), ('D6', 1, NOW()), ('D7', 1, NOW()), ('D8', 1, NOW()), ('D9', 1, NOW()), ('D10', 1, NOW()), ('D11', 1, NOW()), ('D12', 1, NOW()),
    ('E1', 1, NOW()), ('E2', 1, NOW()), ('E3', 1, NOW()), ('E4', 1, NOW()), ('E5', 1, NOW()), ('E6', 1, NOW()), ('E7', 1, NOW()), ('E8', 1, NOW()), ('E9', 1, NOW()), ('E10', 1, NOW()), ('E11', 1, NOW()), ('E12', 1, NOW()),
    ('F1', 1, NOW()), ('F2', 1, NOW()), ('F3', 1, NOW()), ('F4', 1, NOW()), ('F5', 1, NOW()), ('F6', 1, NOW()), ('F7', 1, NOW()), ('F8', 1, NOW()), ('F9', 1, NOW()), ('F10', 1, NOW()), ('F11', 1, NOW()), ('F12', 1, NOW()),
    ('G1', 1, NOW()), ('G2', 1, NOW()), ('G3', 1, NOW()), ('G4', 1, NOW()), ('G5', 1, NOW()), ('G6', 1, NOW()), ('G7', 1, NOW()), ('G8', 1, NOW()), ('G9', 1, NOW()), ('G10', 1, NOW()), ('G11', 1, NOW()), ('G12', 1, NOW()),
    ('H1', 1, NOW()), ('H2', 1, NOW()), ('H3', 1, NOW()), ('H4', 1, NOW()), ('H5', 1, NOW()), ('H6', 1, NOW()), ('H7', 1, NOW()), ('H8', 1, NOW()), ('H9', 1, NOW()), ('H10', 1, NOW()), ('H11', 1, NOW()), ('H12', 1, NOW());
...
INSERT INTO cat_profesores(cnombre_profesor, bhabilitado, dfecha_alta)
VALUES  
    ('Ricardo Guzman Fuentes', 1, NOW()),
    ('María López Ramírez', 1, NOW()),
    ('Juan Pérez Gómez', 1, NOW()),
    ('Laura Sánchez Díaz', 1, NOW()),
    ('Carlos Herrera Montes', 1, NOW()),
    ('Fernanda Torres Rivas', 1, NOW()),
    ('Alejandro Vargas Medina', 1, NOW()),
    ('Gabriela Castillo Ruiz', 1, NOW()),
    ('Luis Ortega Pineda', 1, NOW()),
    ('Verónica Mendoza Cruz', 1, NOW()),
    ('José Ramírez Salgado', 1, NOW()),
    ('Patricia Fernández Núñez', 1, NOW()),
    ('Héctor Gutiérrez Morales', 1, NOW()),
    ('Silvia Rojas Jiménez', 1, NOW()),
    ('Antonio Márquez Estrada', 1, NOW()),
    ('Diana Castro Villalobos', 1, NOW()),
    ('Miguel Navarro León', 1, NOW()),
    ('Beatriz Soto Herrera', 1, NOW()),
    ('Raúl Salinas Delgado', 1, NOW()),
    ('Mónica Estrada Vargas', 1, NOW()),
    ('César Morales Jiménez', 1, NOW()),
    ('Adriana Delgado Torres', 1, NOW()),
    ('Javier Villanueva Paredes', 1, NOW()),
    ('Elena Suárez Aguilar', 1, NOW()),
    ('Francisco Medina Pacheco', 1, NOW()),
    ('Guadalupe Núñez Romero', 1, NOW()),
    ('Arturo Ríos Peralta', 1, NOW()),
    ('Rosa Ramírez Campos', 1, NOW()),
    ('Fernando Juárez García', 1, NOW()),
    ('Leticia Montoya Guzmán', 1, NOW()),
    ('Jorge Fuentes Espinoza', 1, NOW()),
    ('Isabel Martínez Valdez', 1, NOW()),
    ('Oscar Carrillo Torres', 1, NOW()),
    ('Carmen Chávez Arriaga', 1, NOW()),
    ('Roberto Vázquez Peña', 1, NOW()),
    ('Nancy Domínguez Soto', 1, NOW()),
    ('Hugo Paredes Trejo', 1, NOW()),
    ('Alejandra Vargas Cano', 1, NOW()),
    ('Esteban López Salinas', 1, NOW()),
    ('Daniela Ramírez Morales', 1, NOW()),
    ('Manuel Ortega Serrano', 1, NOW()),
    ('Paola Castillo Núñez', 1, NOW()),
    ('Jesús Pérez Marín', 1, NOW()),
    ('Lucía Herrera Montiel', 1, NOW()),
    ('Eduardo Gálvez Orozco', 1, NOW()),
    ('Sara Gutiérrez Pineda', 1, NOW()),
    ('Víctor Torres Delgado', 1, NOW()),
    ('Ximena Suárez Juárez', 1, NOW()),
    ('Andrés Navarro García', 1, NOW()),
    ('Monserrat Salinas Ramírez', 1, NOW()),
    ('Ramón Álvarez Guzmán', 1, NOW()),
    ('Norma Escobar Mendoza', 1, NOW()),
    ('Felipe Camacho Ortega', 1, NOW()),
    ('Sandra Rivas Herrera', 1, NOW()),
    ('Raúl Pacheco Montoya', 1, NOW()),
    ('Mariana Estrada Ríos', 1, NOW()),
    ('Ángel Juárez Valdez', 1, NOW()),
    ('Victoria Gálvez Soto', 1, NOW()),
    ('Iván Montiel Chávez', 1, NOW()),
    ('Emilia Vázquez Peña', 1, NOW()),
    ('Santiago Domínguez Cano', 1, NOW()),
    ('Regina Peralta Pineda', 1, NOW()),
    ('Pablo Carrillo Trejo', 1, NOW()),
    ('Rocío Torres Guzmán', 1, NOW()),
    ('Marco Estrada Pérez', 1, NOW()),
    ('Clara López Ramírez', 1, NOW()),
    ('Diego Fernández Morales', 1, NOW()),
    ('Julia Martínez Montiel', 1, NOW()),
    ('José Luis Navarro Herrera', 1, NOW()),
    ('Ana Montoya Salgado', 1, NOW()),
    ('Cristian Suárez Valdez', 1, NOW()),
    ('Marisol Álvarez Gálvez', 1, NOW()),
    ('Tomás Ortega Ríos', 1, NOW()),
    ('Fabiola Guzmán Soto', 1, NOW()),
    ('Gerardo Ramírez Estrada', 1, NOW()),
    ('Martha Juárez Salinas', 1, NOW()),
    ('Humberto Vázquez Camacho', 1, NOW()),
    ('Natalia Gutiérrez Trejo', 1, NOW()),
    ('Ignacio Castillo Marín', 1, NOW()),
    ('Teresa Montiel Rivas', 1, NOW()),
    ('Raquel Fernández Pérez', 1, NOW()),
    ('Salvador Ortega García', 1, NOW()),
    ('Berenice Estrada Valdez', 1, NOW()),
    ('Guillermo Herrera Gálvez', 1, NOW()),
    ('Daniela Torres Núñez', 1, NOW()),
    ('Mauricio Camacho Chávez', 1, NOW()),
    ('Verónica Ríos Orozco', 1, NOW()),
    ('Ismael Ramírez Domínguez', 1, NOW()),
    ('Vanessa López Peralta', 1, NOW()),
    ('Adrián Salinas Montoya', 1, NOW()),
    ('Gloria Pacheco Trejo', 1, NOW()),
    ('Bruno Gutiérrez Peña', 1, NOW()),
    ('Cecilia Suárez Soto', 1, NOW()),
    ('Enrique Vázquez Cano', 1, NOW()),
    ('Delfina Álvarez Torres', 1, NOW()),
    ('Rolando Carrillo Montiel', 1, NOW()),
    ('María Elena Gálvez Ortega', 1, NOW()),
    ('Eugenio Estrada Valdez', 1, NOW()),
    ('Yesenia Fernández Ramírez', 1, NOW()),
    ('Horacio Navarro Guzmán', 1, NOW()),
    ('Alfonso Martínez Pérez', 1, NOW()),
    ('Andrea Herrera Marín', 1, NOW()),
    ('Cinthia Rivas Domínguez', 1, NOW()),
    ('Leonardo Montoya Salinas', 1, NOW()),
    ('Elsa Peralta Trejo', 1, NOW()),
    ('Felipe Gutiérrez Chávez', 1, NOW()),
    ('Margarita Suárez Orozco', 1, NOW()),
    ('Alberto Ramírez Ríos', 1, NOW()),
    ('Dolores Pacheco Núñez', 1, NOW()),
    ('Jesús Salinas Estrada', 1, NOW()),
    ('Renata Camacho Vázquez', 1, NOW()),
    ('Álvaro Ortega Montiel', 1, NOW()),
    ('Mónica Gálvez Herrera', 1, NOW());


INSERT INTO cat_periodos(cperiodo, canio, bhabilitado, dfecha_alta)
VALUES  
    ('2001-1', '2001', 1, NOW()), ('2001-2', '2001', 1, NOW()),
    ('2002-1', '2002', 1, NOW()), ('2002-2', '2002', 1, NOW()),
    ('2003-1', '2003', 1, NOW()), ('2003-2', '2003', 1, NOW()),
    ('2004-1', '2004', 1, NOW()), ('2004-2', '2004', 1, NOW()),
    ('2005-1', '2005', 1, NOW()), ('2005-2', '2005', 1, NOW()),
    ('2006-1', '2006', 1, NOW()), ('2006-2', '2006', 1, NOW()),
    ('2007-1', '2007', 1, NOW()), ('2007-2', '2007', 1, NOW()),
    ('2008-1', '2008', 1, NOW()), ('2008-2', '2008', 1, NOW()),
    ('2009-1', '2009', 1, NOW()), ('2009-2', '2009', 1, NOW()),
    ('2010-1', '2010', 1, NOW()), ('2010-2', '2010', 1, NOW()),
    ('2011-1', '2011', 1, NOW()), ('2011-2', '2011', 1, NOW()),
    ('2012-1', '2012', 1, NOW()), ('2012-2', '2012', 1, NOW()),
    ('2013-1', '2013', 1, NOW()), ('2013-2', '2013', 1, NOW()),
    ('2014-1', '2014', 1, NOW()), ('2014-2', '2014', 1, NOW()),
    ('2015-1', '2015', 1, NOW()), ('2015-2', '2015', 1, NOW()),
    ('2016-1', '2016', 1, NOW()), ('2016-2', '2016', 1, NOW()),
    ('2017-1', '2017', 1, NOW()), ('2017-2', '2017', 1, NOW()),
    ('2018-1', '2018', 1, NOW()), ('2018-2', '2018', 1, NOW()),
    ('2019-1', '2019', 1, NOW()), ('2019-2', '2019', 1, NOW()),
    ('2020-1', '2020', 1, NOW()), ('2020-2', '2020', 1, NOW()),
    ('2021-1', '2021', 1, NOW()), ('2021-2', '2021', 1, NOW()),
    ('2022-1', '2022', 1, NOW()), ('2022-2', '2022', 1, NOW()),
    ('2023-1', '2023', 1, NOW()), ('2023-2', '2023', 1, NOW()),
    ('2024-1', '2024', 1, NOW()), ('2024-2', '2024', 1, NOW()),
